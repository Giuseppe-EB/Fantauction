...
<title>riepilogoAsta - Prova - WEBSITE X5 DEMO VERSION </title>
		<meta charset="utf-8" />
		...
		<meta property="og:url" content="http://eagsatea.it/riepilogoasta.html" />
		<meta property="og:title" content="riepilogoAsta" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/riepilogoasta.css?14-0-6-1-637178218618748609" media="screen,print" />
		...
		<script type="text/javascript">
			...
			x5engine.utils.currentPagePath = 'riepilogoasta.html';
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">riepilogoAsta - Prova - WEBSITE X5 DEMO VERSION </h1>
...
$(function () {$('#imStickyBar_imMenuObject_03 ul li').each(function () {    var $this = $(this), timeout = 0, subtimeout = 0, width = 'none', height = 'none';        var submenu = $this.children('ul').add($this.find('.multiple-column > ul'));    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_03-menu-opened').length > 0) return;         clearTimeout(timeout);        clearTimeout(subtimeout);        $this.children('.multiple-column').show(0);        submenu.stop(false, false);        if (width == 'none') {             width = submenu.width();        }        if (height == 'none') {            height = submenu.height();            submenu.css({ overflow : 'hidden', height: 0});        }        setTimeout(function () {         submenu.css({ overflow : 'hidden'}).fadeIn(1).animate({ height: height }, 300, null, function() {$(this).css('overflow', 'visible'); });        }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_03-menu-opened').length > 0) return;         timeout = setTimeout(function () {         submenu.stop(false, false);            submenu.css('overflow', 'hidden').animate({ height: 0 }, 300, null, function() {$(this).fadeOut(0); });            subtimeout = setTimeout(function () { $this.children('.multiple-column').hide(0); }, 300);        }, 250);    });});});
				...
				<div id="imCell_2" class="" > <div id="imCellStyleGraphics_2"></div><div id="imCellStyle_2"  data-responsive-sequence-number="1"><div id="imTableObject_8_02">
					<div class="text-tab-content"  id="imTableObject_8_02_tab0" style="">
						<div class="text-inner">
							<table data-minrequestedwidth="291" data-computedwidth="291" style="width: 291px;">
								...
								<tbody>
										...
										<tr>
											<td colspan="3" rowspan="1" style=" text-align: center; width: 283px; height: 22px; margin-top: 0px; margin-left: 0px;  background-color: rgb(255, 255, 255);" class="imVt">${giocatori_squadra.getNome() }</td>
										
											
												
												<c:forEach var="giocatori" items="${giocatori_squadra.getGiocatori()}">
												<tr>
													<td colspan="2" rowspan="1" style="text-align: center; width: 151px; height: 21px; margin-top: 0px; margin-left: 0px;  background-color: rgb(255, 255, 255);" class="imVt">${giocatori.getNome()} ${giocatori.getCognome() }</td>
													<td colspan="1" rowspan="1" style="text-align: center; width: 125px; height: 21px; margin-top: 0px; margin-left: 0px; background-color: rgb(255, 255, 255);" class="imVt">${giocatori.getPrezzo() }</td>
												</tr>
												</c:forEach>
										</tr>	
										</c:forEach>
				...
				<div id="imCell_3" class="" > <div id="imCellStyleGraphics_3"></div><div id="imCellStyle_3"  data-responsive-sequence-number="2"><div id="imHTMLObject_8_03" class="imHTMLObject" style="height: 350px; overflow: auto; text-align: center;"><script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
				<a href="#" onClick ="$('#table').tableExport({type:'excel',escape:'false'});" class="excel">Download Excel</a>
				<script type="text/javascript" src="js/excel.js"></script></div></div></div></div>
				</div>
